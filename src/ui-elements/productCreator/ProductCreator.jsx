...
const ProductCreator = () => {
  ...
  const addLayerHandler = (layerType) => { dispatch(addLayer(layerType)) }
  const setToppingsHandler = (topping) => { dispatch(setToppings(topping)) }
  const removeLastLayerHandler = () => { dispatch(removeLastLayer()) }
  const resetHandler = () => { dispatch(reset()) }
  const setFrostingFlavorHandler = (flavor) => { dispatch(setFrostingFlavor(flavor)) }
  const setTierFlavorHandler = (flavor) => { dispatch(setTierFlavor(flavor)) }
  ...
  return (
    <div id='product-creator' className='product-creator'>
      ...
      <div className='flavor-menus'>
        <p>Tiers: </p>
        <select className='flavor-menu' name='tier-flavors' onChange={(e) => {
        ...
        <p>Frostings: </p>
        <select className='flavor-menu' name='frosting-flavors' onChange={(e) => {
      ...
      <div className='control-panel'>
        <button onClick={() => { addLayerHandler('tier') }}>Add tier</button>
